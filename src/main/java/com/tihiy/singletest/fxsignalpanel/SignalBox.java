...
public class SignalBox  extends VBox{
    private Polyline polyline;
    private ScrollBar bar;
    private int scrollValue;
    private int scale = 50;

    public SignalBox(double[] array) {
        super();
        ...
        layoutBoundsProperty().addListener(new ChangeListener<Bounds>() {
            ...
            public void changed(ObservableValue<? extends Bounds> observable, Bounds oldValue, Bounds newValue) {
                ...
                polyline.setScaleY(getScaleY());
            }
        });
        getChildren().addAll(polyline = fillPoliline(array));
        getChildren().addAll(initScrollBar());
